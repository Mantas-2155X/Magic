...
namespace Combat.Spells
{
	public class CreateTorus : BaseSpell
	{
		public override bool FinishCasting()
		{
			...
			var torus = AIManager.Instance.CreateNPC(spawnPos, Vector3.zero, (NPCData)ObjectManager.Instance.GetData<AliveData>("AI_TORUS_NAME"), null, Owner.RelationshipGroup);
